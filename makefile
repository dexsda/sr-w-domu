...
build: 
	python create_recaps.py > generated_files/recaps.html
	python create_website.py > generated_files/index.html
	python create_website.py -g > generated_files/index-secret-for-gm.html
	tidy -w 160 -i -q --tidy-mark=no -m generated_files/index.html generated_files/index-secret-for-gm.html generated_files/recaps.html 2>/dev/null || exit 0
